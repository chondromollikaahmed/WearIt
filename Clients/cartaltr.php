			...
			<div class="row">
				<div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
					<div class="m-l-25 m-r--38 m-lr-0-xl">
                        ...
                        <form action="cartremove.php" method="POST" id="abcd">
</form>
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-1">
											<button form="abcd" class="btn btn-sm btn-outline-danger" name="remove">Remove</button>
											<input form="abcd" type="hidden" name="item_name" value="<?php echo $value['item_name'] ?>">
									</td>
